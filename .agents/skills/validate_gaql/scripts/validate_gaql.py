...
def validate_gaql(
    ...
    Args:
        ...
        api_version: The API version to use (e.g., "v24").
    ...
    # Rule 4.2.1: Any core date segment in SELECT requires a finite DURING or BETWEEN filter in WHERE
    ...
    # Rule 4.2.2: Queries against click_view require a single-day filter on segments.date
    ...
    # Rule 4.2.3: Queries against change_status require a finite BETWEEN filter on last_change_date_time and a LIMIT (max 10,000)
